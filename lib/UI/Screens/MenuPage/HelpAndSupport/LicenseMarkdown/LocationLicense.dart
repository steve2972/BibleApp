...
## 복음서원 위치기반서비스 이용약관
### 제 1 조 (목적)
본 약관은 주식회사 복음서원(이하 "회사")가 제공하는 위치기반서비스에 대해 회사와 위치기반서비스를 이용하는 개인위치정보주체(이하 "이용자")간의 권리·의무 및 책임사항, 기타 필요한 사항 규정을 목적으로 합니다.
### 제 2 조 (이용약관의 효력 및 변경)
...
class LocationLicense extends StatelessWidget {
  @override

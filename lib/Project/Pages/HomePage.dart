...
class HomePageState extends State<HomePage> {
  ...
  //TODO: create separate file in (Feature/Navigation/Views/Appbar) to implement appbar
    ...
    return Drawer(
      child: ListView(
        ...
        children: <Widget>[
          ...
          createDrawerListTiles(Icons.folder_open, "내 파일"),
          ...
          Divider(),
          createDrawerListTiles(Icons.history, "읽은 기록"),
